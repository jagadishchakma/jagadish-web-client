import { faGlobe, faList, faListAlt, faPlus, faTachometerAlt, faUser, faUserShield } from '@fortawesome/free-solid-svg-icons';
    ...
    return (
        <div className="dash-sidebar ubunto" style={display && block}>
            <ul>
                ...
                <li className={active === 'enrolledList' ? 'active' : null}><Link to="/admin/enrolledList"><FontAwesomeIcon icon={faListAlt}/> Enrolled List</Link></li>
